...
INSERT INTO `auth_assignment` VALUES ('admin','1',NULL),('admin','8',1488217879),('usuario','1',1488207422),('usuario','10',1488801359),('usuario','11',1488801387),('usuario','2',1488191008),('usuario','3',1487936897),('usuario','5',1487943672),('usuario','7',1488217490),('usuario','8',1488217834),('usuario','9',1488382485);
...
INSERT INTO `menu` VALUES (2,'Admon :: Backend',NULL,'/admon',1,NULL),(3,'My Cards',NULL,'/post/index',4,NULL),(5,'Home',NULL,'/site/index',1,NULL),(6,'About',NULL,'/site/about',2,NULL),(7,'Contact',NULL,'/site/contact',3,NULL);
...
INSERT INTO `token` VALUES (5,'0r-OUglbgXAZXAPgXlfAZIfC5-wwgU3u',1487943672,0),(10,'TsZyIAG1IshNcUpwa4ZTfX-ACBJ6iKAV',1488801359,0);
...
INSERT INTO `profile` VALUES (1,'','','','d41d8cd98f00b204e9800998ecf8427e','','','',NULL),(2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,'Jesús Rey',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(8,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(9,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(10,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(11,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='post table';

#
# Data for table "post"
#

INSERT INTO `post` VALUES (2,'another post',NULL,NULL,'kajdlkajsdlkasjdaslkdjasd','es-ES','lightyellow',NULL,NULL,NULL,8,1488478386,1488535178,10),(3,'adsfasfasdf',NULL,NULL,'afdsfasdfasdfasdf','es-ES',NULL,NULL,NULL,NULL,8,1488469733,1488469733,10),(4,'post fb user',NULL,NULL,'post fb user','es-ES',NULL,NULL,NULL,NULL,7,1488473812,1488473812,10),(5,'Another fb user post',NULL,NULL,'Another fb user post','es-ES',NULL,NULL,NULL,NULL,7,1488475166,1488534739,10),(6,'kjadhsfjashfkahds',NULL,NULL,'jhkjhsakjhdjksahdsakjd','es-ES',NULL,NULL,NULL,NULL,8,1488535282,1488535419,0),(7,'post with photos',NULL,NULL,'post with photos','es-ES',NULL,NULL,NULL,NULL,8,1488541215,1488541215,10),(8,'post from user',NULL,NULL,'post form regular user','es-ES',NULL,NULL,NULL,NULL,2,1488547751,1488547751,10),(9,'',NULL,NULL,'','es-ES',NULL,NULL,NULL,NULL,8,1488548928,1488548928,10),(10,'test','test','test','<p>test</p>\r\n','es-ES','white',NULL,NULL,NULL,8,1488795577,1488795657,10),(11,'dfasd','fasdfas','dfasdf','<p>sadfasdf</p>\r\n','es-ES','#ffd966',NULL,NULL,NULL,8,1488795715,1488795715,10);
